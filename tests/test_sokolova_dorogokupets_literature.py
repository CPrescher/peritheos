...
@pytest.mark.parametrize(
    ...
    [
        (
            dict(V0=1.0272, K0=99.65, K0_prime=6.11, theta_B1=130.6,
                 d_B1=8.572, m_B1=0.121, theta_B2=103.6, d_B2=5.326,
                 m_B2=0.449, theta_E1=111.9, m_E1=0.766, theta_E2=189.12,
                 m_E2=1.664, gamma0=2.376, gamma_inf=1.481, beta=2.507,
                 anharmonic_a=6.70, anharmonic_m=3.44, electronic_e=25.9,
                 electronic_g=0.666, defect_H=15239, defect_S=0.732, n=1),
            0.6, 2500.0, 233.648, 0.003,
        ),
        (
            dict(V0=0.9999, K0=72.67, K0_prime=4.62, theta_B1=245.8,
                 d_B1=5.575, m_B1=0.987, theta_E1=240.2, m_E1=1.000,
                 theta_E2=356.2, m_E2=1.013, gamma0=2.144,
                 gamma_inf=1.017, beta=3.942, anharmonic_a=5.14,
                 anharmonic_m=3.44, electronic_e=54.1, electronic_g=1.8,
                 defect_H=8679, defect_S=0.998, n=1),
            0.5, 2500.0, 230.556, 0.17,
        ),
        (
            dict(V0=1.0215, K0=166.70, K0_prime=6.00, theta_B1=95.7,
                 d_B1=8.290, m_B1=0.681, theta_B2=106.4, d_B2=3.239,
                 m_B2=0.417, theta_E1=170.6, m_E1=1.063, theta_E2=105.2,
                 m_E2=0.839, gamma0=2.965, gamma_inf=1.142, beta=3.030,
                 anharmonic_a=25.33, anharmonic_m=3.79, electronic_e=18.92,
                 electronic_g=0.66, defect_H=11690, defect_S=1.067, n=1),
            0.65, 2500.0, 256.35, 0.01,
        ),
        (
            dict(V0=0.7113, K0=133.41, K0_prime=5.37, theta_B1=123.7,
                 d_B1=3.776, m_B1=0.115, theta_B2=175.4, d_B2=10.372,
                 m_B2=0.711, theta_E1=187.4, m_E1=0.756, theta_E2=286.9,
                 m_E2=1.418, gamma0=1.974, gamma_inf=1.554, beta=4.647,
                 anharmonic_a=3.50, anharmonic_m=3.46,
                 electronic_e=27.698, electronic_g=0.666, defect_H=11687,
                 defect_S=1.407, n=1),
            0.6, 2500.0, 265.581, 0.23,
        ),
        (
            dict(V0=0.9091, K0=276.07, K0_prime=5.30, theta_B1=95.2,
                 d_B1=8.199, m_B1=0.329, theta_B2=148.4, d_B2=4.005,
                 m_B2=0.383, theta_E1=214.6, m_E1=1.211, theta_E2=140.8,
                 m_E2=1.077, gamma0=2.802, gamma_inf=1.538, beta=5.550,
                 anharmonic_a=160.9, anharmonic_m=4.06, electronic_e=260.0,
                 electronic_g=2.4, defect_H=32572, defect_S=0.631, n=1),
            0.7, 3000.0, 262.523, 0.02,
        ),
        (
            dict(V0=1.0851, K0=191.39, K0_prime=3.81, theta_B1=72.6,
                 d_B1=5.536, m_B1=0.117, theta_B2=101.8, d_B2=24.513,
                 m_B2=0.396, theta_E1=144.0, m_E1=1.118, theta_E2=214.9,
                 m_E2=1.369, gamma0=1.714, gamma_inf=1.241, beta=6.825,
                 anharmonic_a=61.9, anharmonic_m=4.00, electronic_e=167.0,
                 electronic_g=1.3, defect_H=36278, defect_S=4.910, n=1),
            0.6, 3000.0, 258.537, 0.16,
        ),
        (
            dict(V0=0.9545, K0=306.00, K0_prime=4.17, theta_B1=182.8,
                 d_B1=13.270, m_B1=0.513, theta_B2=172.5, d_B2=3.305,
                 m_B2=0.174, theta_E1=287.6, m_E1=1.166, theta_E2=213.8,
                 m_E2=1.145, gamma0=1.553, gamma_inf=0.694, beta=3.698,
                 anharmonic_a=-39.3, anharmonic_m=2.67, electronic_e=40.4,
                 electronic_g=0.2, defect_H=14714, defect_S=0.672, n=1),
            0.7, 3000.0, 232.448, 0.061,
        ),
        (
            dict(V0=1.1248, K0=160.31, K0_prime=4.18, theta_B1=447.3,
                 d_B1=11.248, m_B1=1.429, theta_B2=384.0, d_B2=3.593,
                 m_B2=0.276, theta_E1=703.8, m_E1=2.570, theta_E2=466.0,
                 m_E2=1.725, gamma0=1.522, gamma_inf=1.111, beta=4.509,
                 anharmonic_a=13.56, anharmonic_m=5.23, n=2),
            0.6, 3000.0, 243.935, 0.145,
        ),
        (
            dict(V0=0.3417, K0=443.16, K0_prime=3.777, theta_B1=1202.1,
                 d_B1=9.604, m_B1=1.163, theta_B2=1135.1, d_B2=3.380,
                 m_B2=0.218, theta_E1=1687.2, m_E1=1.396,
                 theta_E2=1033.7, m_E2=0.223, gamma0=0.820,
                 gamma_inf=0.615, beta=10.121, anharmonic_a=-23.85,
                 anharmonic_m=1.22, n=1),
            0.7, 3000.0, 316.383, 0.015,
        ),
    ],
)
...
def _corrected_2013_eos(material):
    if material == "Mo":
        return MultiOscillatorGruneisenThermalEOS(
            ...
            Tr=298.15, QE1o=356.0, mE1=1.5, QE2o=218.0, mE2=1.5,
            delta=-0.755, t=-0.735, a_0=0.0, m=0.0, e_0=123.9,
            g=3.5, n=1.0,
        )
    return MultiOscillatorGruneisenThermalEOS(
        Holzapfel(1.0215, 167.0, 5.75, 1.0, 79.0),
        Tr=298.15, QE1o=176.0, mE1=1.5, QE2o=84.0, mE2=1.5,
        delta=0.045, t=-0.463, a_0=0.0, m=0.0, e_0=0.0,
        g=0.0, n=1.0,
    )
...
def test_sokolova_2013_corrected_mo_and_au_tables(material, ratio, temperature, expected):
...
def test_sokolova_2013_corrected_mgo_parameters_do_not_reproduce_table_6():
    eos = MultiOscillatorGruneisenThermalEOS(
        ...
        Tr=298.15, QE1o=748.0, mE1=3.0, QE2o=401.0, mE2=3.0,
        delta=-0.25, t=0.583, a_0=17.4, m=5.5, e_0=0.0,
        g=0.0, n=2.0,
    )
...
def test_dorogokupets_2010_figure_1_quantifies_both_model_mismatches():
    ...
    for row in rows:
        ...
        fit_2_ratio = brentq(
            lambda ratio: _dorogokupets_2010_fit_2_pressure(ratio, 3663.0)
            - pressure,
            0.5,
            0.9,
        )
...
def test_sokolova_2016_figure_3_digitization_prefers_workbook_form():
    ...
    assert workbook_rmse == pytest.approx(0.4665953, abs=1.0e-7)
    assert printed_rmse == pytest.approx(9.7740234, abs=1.0e-7)
