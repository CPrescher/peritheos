...
def test_ambiguous_material_alias_requires_a_stable_identifier():
    with pytest.raises(KeyError, match="Ambiguous material alias.*Fe27") as error:
        get_material("Fe27")

    assert error.value.context == {
        "identifier": "Fe27",
        "matches": ("ferropericlase_fe27", "mg073fe027o"),
    }
