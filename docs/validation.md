...
separate. All 286 bundled material documents and 817 EOS records pass the
...
The primary-source audit covers all 817 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 817
...
diagnostics. The current campaign finds 155 uncertainty-parity matches and 66
additional numerically similar results. [34 direct refits](primary-eos-refits.md#parity-not-achieved) do not
recover at least one published coefficient, while 562 records cannot be
