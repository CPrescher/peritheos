...
separate. All 286 bundled material documents and 826 EOS records pass the
...
The primary-source audit covers all 826 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 826
...
diagnostics. The current campaign finds 155 uncertainty-parity matches and 74
additional numerically similar results. [31 direct refits](primary-eos-refits.md#parity-not-achieved) do not
recover at least one published coefficient, while 566 records cannot be
