...
separate. All 208 bundled material documents and 488 EOS records pass the
...
The primary-source audit covers all 488 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 488
...
diagnostics. The current campaign finds 157 uncertainty-parity matches and 87
additional numerically similar results. [31 direct refits](primary-eos-refits.md#parity-not-achieved) do not
recover at least one published coefficient, while 213 records cannot be
