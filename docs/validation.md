...
separate. All 215 bundled material documents and 586 EOS records pass the
format-3 validator; 214 documents construct executable materials and the
...
The primary-source audit covers all 586 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 586
...
diagnostics. The current campaign finds 199 parity matches and 144 additional numerically similar results.
