...
separate. All 286 bundled material documents and 812 EOS records pass the
...
The primary-source audit covers all 812 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 812
