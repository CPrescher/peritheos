...
separate. All 286 bundled material documents and 816 EOS records pass the
...
The primary-source audit covers all 816 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 816
...
diagnostics. The current campaign finds 161 uncertainty-parity matches and 66
additional numerically similar results. [32 direct refits](primary-eos-refits.md#parity-not-achieved) do not
recover at least one published coefficient, while 548 records cannot be
