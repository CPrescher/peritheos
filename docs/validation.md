...
separate. All 286 bundled material documents and 815 EOS records pass the
...
The primary-source audit covers all 815 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 815
...
diagnostics. The current campaign finds 157 uncertainty-parity matches and 62
