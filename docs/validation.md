...
separate. All 212 bundled material documents and 583 EOS records pass the
...
The primary-source audit covers all 583 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 583
...
diagnostics. The current campaign finds 199 parity matches and 142 additional numerically similar results.
