...
separate. All 141 bundled material documents and 223 EOS records pass the
...
The primary-source audit covers all 223 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 223
...
diagnostics. The current campaign finds 113 uncertainty-parity matches and 44
additional numerically similar results. [Eighteen direct refits](primary-eos-refits.md#parity-not-achieved) do not
recover at least one published coefficient, while 48 records cannot be
