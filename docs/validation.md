...
separate. All 145 bundled material documents and 233 EOS records pass the
...
The primary-source audit covers all 233 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 233
