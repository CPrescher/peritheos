...
separate. All 118 bundled material documents and 172 EOS records pass the
...
The primary-source audit covers all 172 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 172
