...
separate. All 139 bundled material documents and 217 EOS records pass the
...
The primary-source audit covers all 217 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 217
