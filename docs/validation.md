...
separate. All 214 bundled material documents and 585 EOS records pass the
format-3 validator; 213 documents construct executable materials and the
...
The primary-source audit covers all 585 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 585
