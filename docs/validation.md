...
separate. All 285 bundled material documents and 654 EOS records pass the
...
The primary-source audit covers all 654 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 654
...
recover at least one published coefficient, while 428 records cannot be
