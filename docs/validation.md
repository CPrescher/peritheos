...
separate. All 155 bundled material documents and 253 EOS records pass the
...
The primary-source audit covers all 253 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 253
