...
separate. All 223 bundled material documents and 610 EOS records pass the
format-3 validator; 222 documents construct executable materials and the
...
The primary-source audit covers all 610 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 610
...
diagnostics. The current campaign finds 220 parity matches and 146 additional numerically similar results.
