...
separate. All 212 bundled material documents and 577 EOS records pass the
format-3 validator; 211 documents construct executable materials and the
...
The primary-source audit covers all 577 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 577
...
diagnostics. The current campaign finds 200 parity matches and 135 additional numerically similar results.
