...
separate. All 286 bundled material documents and 821 EOS records pass the
...
The primary-source audit covers all 821 bundled records. Every record is
...
fit for every record with sufficient direct observations and documents all 821
...
diagnostics. The current campaign finds 162 uncertainty-parity matches and 70
