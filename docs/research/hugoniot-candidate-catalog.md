...
The complete repository inventory is in [`docs/data/hugoniot-material-inventory.csv`](../data/hugoniot-material-inventory.csv). It contains 116 material documents, 161 equilibrium records (123 isothermal and 38 thermal), and two production Hugoniot records, for 163 records total. Phase identity is taken from the explicit phase field where present and otherwise from the material name and crystal structure.
