...
|  | `mg075fe025o_solomatova_2016_hs_bm3_reference_1` | published coefficients were not recovered |
|  | `mg075fe025o_solomatova_2016_ls_bm3_reference_2` | published coefficients were not recovered |
...
| [Holmes et al. (1989)](https://doi.org/10.1063/1.344177) | `platinum_holmes_1989_vinet_1` | Equation (11) and Table IV make the published 300 K Vinet curve exactly reconstructable, but the source does not tabulate its LMTO E0(V), P0(V), density-of-states, or 300 K fit grid. The bundled Table III rows are shock-Hugoniot qualification experiments and must not be fitted as a 300 K isotherm; the source-derived equation checkpoints are circular fit inputs. The underlying theoretical regression therefore remains not independently refittable. |
| [Ismailova et al. (2016)](https://doi.org/10.1126/sciadv.1600427) | `fe088sio3_bridgmanite_ismailova_2016_300k_bm2` | Supplementary Table S2 bundles only four selected crystallographic states, while Figure 3A plots substantially more compression and decompression markers for the published BM2 fit. The source gives no complete row list, inclusion/exclusion flags, regression objective, numerical weights, or row-wise Ne calibrant volumes. The four exact rows are checkpoint data, not a defensible reconstruction of the source fit input. |
...
| [Anzellini et al. (2025)](https://doi.org/10.1038/s43246-025-00963-4) | Reproduced | 1 | 1 parity | 1 bundled |
| [B8 Fe0.94O, Fischer et al. (2011)](https://doi.org/10.1016/j.epsl.2011.02.025) | Reproduced | 2 | 2 parity | 2 bundled |
...
| [Benedict et al. (2014)](https://doi.org/10.1103/physrevb.89.224109) | Coefficient parity not achieved | 1 | 1 parity not achieved | 1 bundled |
...
| [Campbell et al. (2009)](https://doi.org/10.1016/j.epsl.2009.07.022) | Mixed: reproduced and discrepant records | 4 | 1 similar; 3 parity not achieved | 4 bundled |
...
| [Datchi et al. (2007)](https://doi.org/10.1103/physrevb.75.214104) | Reproduced | 3 | 1 parity; 2 similar | 2 bundled; 1 plot only/digitized |
...
| [Dewaele (2019)](https://doi.org/10.3390/min9110684) | Mixed: reproduced and discrepant records | 31 | 1 parity; 24 similar; 4 parity not achieved; 2 direct refit unavailable | 27 bundled; 2 partial primary rows bundled; 2 parameterization only |
...
| [Hirose et al. (2008)](https://doi.org/10.1016/j.pepi.2008.03.002) | Reproduced | 3 | 3 similar | 3 bundled |
...
| [Ismailova et al. (2016)](https://doi.org/10.1126/sciadv.1600427) | Direct refit unavailable | 1 | 1 direct refit unavailable | 1 partial published table/checkpoints |
...
| [Komabayashi et al. (2008)](https://doi.org/10.1016/j.epsl.2007.10.036) | Reproduced | 1 | 1 similar | 1 bundled |
...
| [Kuznetsov et al. (2002)](https://doi.org/10.1016/s0038-1098(02)00112-6) | Direct refit unavailable | 2 | 2 direct refit unavailable | 2 partial primary rows bundled |
...
| [Litasov et al. (2007)](https://doi.org/10.1016/j.pepi.2007.06.003) | Reproduced | 7 | 7 similar | 7 bundled |
| [Litasov et al. (2013)](https://doi.org/10.1016/j.pepi.2013.07.011) | Reproduced | 2 | 1 parity; 1 similar | 2 bundled |
...
| [Mao et al. (1991)](https://doi.org/10.1029/91jb00176) | Reproduced | 3 | 3 parity | 3 bundled |
...
| [Sakai et al. (2011)](https://doi.org/10.1063/1.3573393) | Reproduced | 8 | 8 parity | 8 bundled; 8 conditional fixed-V0 refits; source weights and marker averaging unspecified |
...
| [Sun et al. (2016)](https://doi.org/10.1002/2016jb013062) | Reproduced | 1 | 1 parity | 1 bundled |
| [Sun et al. (2019)](https://doi.org/10.1029/2018gl081421) | Direct refit unavailable | 1 | 1 direct refit unavailable | 1 bundled |
| [Sun et al. (2019)](https://doi.org/10.1029/2019jb017853) | Reproduced | 2 | 2 similar | 2 bundled |
| [Sun et al. (2022)](https://doi.org/10.2138/am-2021-7913) | Reproduced | 1 | 1 parity | 1 bundled |
...
| [Zhao et al. (1997)](https://doi.org/10.1029/96gl03769) | Reproduced | 1 | 1 similar | 1 bundled |
| [Zhou et al. (2014)](https://doi.org/10.1016/j.pepi.2013.06.005) | Reproduced | 1 | 1 similar | 1 bundled |
