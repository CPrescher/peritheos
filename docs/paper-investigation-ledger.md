...
These **79 papers** contain 216 records for which a
...
| [Shieh et al. (2000)](https://doi.org/10.1016/s0012-821x(00)00033-9) | `phase_d_ant_a_shieh_2000_bm2_1`, `phase_d_ant_b_shieh_2000_bm2_1` | The catalog record preserves a validated published parameterization but does not register row-level observations for an independent refit. |
...
| [Shieh et al. (2000)](https://doi.org/10.1016/s0012-821x(00)00033-9) | Direct refit unavailable | 2 | 2 direct refit unavailable | 2 parameterization only |
