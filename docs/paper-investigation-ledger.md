...
The register covers **327 primary papers**: **229** support the 844 audited catalog records and **98** were investigated without adding a production record.
...
| Reproduced | 143 |
| Partly reproduced | 5 |
| Mixed: reproduced and discrepant records | 6 |
| Coefficient parity not achieved | 13 |
| Direct refit unavailable | 66 |
...
These **19 papers** account for all 36 records
...
These **70 papers** contain 528 records for which a
