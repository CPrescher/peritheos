...
- Suzuki, A. (2016). Pressure-volume-temperature equation of state of
  epsilon-FeOOH to 11 GPa and 700 K. *Journal of Mineralogical and
  Petrological Sciences*, 111, 420--424.
  [doi:10.2465/jmps.160719c](https://doi.org/10.2465/jmps.160719c).
  Peritheos implements Equation (1), the reference-temperature expansivity
  convention printed below it, and the Table 2 parameters, and preserves all
  33 Table 1 observations for validation.
