...
the distributed catalog to 155 materials and 253 EOS records. Native records
...
print(len(list_material_documents()))  # 155
...
marks all 253 bundled records `primary_source_validated`; no record remains
