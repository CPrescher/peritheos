...
the distributed catalog to 257 materials and 553 EOS records. Native records
...
print(len(list_material_documents()))  # 257
...
marks all 553 bundled records `primary_source_validated`; no record remains
