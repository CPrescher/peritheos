...
the distributed catalog to 145 materials and 233 EOS records. Native records
...
print(len(list_material_documents()))  # 145
...
marks all 233 bundled records `primary_source_validated`; no record remains
