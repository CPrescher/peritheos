...
the distributed catalog to 285 materials and 654 EOS records. Native records
...
print(len(list_material_documents()))  # 285
...
marks all 654 bundled records `primary_source_validated`; no record remains
