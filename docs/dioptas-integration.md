...
the distributed catalog to 141 materials and 223 EOS records. Native records
...
print(len(list_material_documents()))  # 141
...
marks all 223 bundled records `primary_source_validated`; no record remains
