...
the distributed catalog to 182 materials and 353 EOS records. Native records
...
print(len(list_material_documents()))  # 182
...
marks all 353 bundled records `primary_source_validated`; no record remains
