...
contents are exactly the bundled 210-executable-material/581-record collection.
The document API separately exposes all 211 material cards, including cards
...
record in the bundled 581-record collection. Consequently, the old names are not
