...
The campaign covers all **814** EOS records. **163** achieve uncertainty parity, **64** are numerically similar, **[31](#parity-not-achieved)** do not achieve parity, **556** cannot be directly refitted, and **0** attempts failed before comparison.
