...
| [`aluminum_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`aluminum_dewaele_2004_mao_ruby_vinet`](https://doi.org/10.1103/PhysRevB.70.094112) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`barium_bcc_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`bismuth_a7_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`ca_perovskite_noguchi_2013_bm2_mgd_1`](https://link.springer.com/article/10.1007/s00269-012-0549-1) | `parameterization_only` | — | — | —/— | not_refittable — Table 1 contains 54 P-V-T rows, paired Fei/Holmes pressures, Pt lattice parameters, and three explicit fit exclusions. A complete local transcription was used for the audit and independent refit, but is not redistributed because the subscription article states no reusable data license. |
| [`ca_perovskite_sun_2016_bm3_3`](https://www.jsg.utexas.edu/lin/files/SunLowerMantleEoSJGR2016.pdf) | `parameterization_only` | — | — | —/— | not_refittable — The published thermal-EOS coefficients are transcribed directly. The article's P-V-T table is not redistributed because no open table-data license was identified. |
...
| [`cadmium_hcp_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`calcium_fcc_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`cesium_bcc_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`chromium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`cobalt_hcp_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`coesite_v_bykova_2018_am05_static_bm3_refit`](https://www.nature.com/articles/s41467-018-07265-z) | `coesite_v_bykova_2018_table10_calc_pv` | — | — | —/— | not_refittable — Table 10 contains only one coesite-V pressure-volume anchor, which is sufficient to verify the published-parameter reconstruction but not to independently refit its three BM3 coefficients. |
...
| [`copper_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`copper_dewaele_2004_mao_ruby_vinet`](https://doi.org/10.1103/PhysRevB.70.094112) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`cu_sun_2010_sms4_1`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Source coefficients are complete and executable, but the fitted row-level compression observations and regression weights are not republished. |
| [`cu_sun_2010_sms3_1`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Source coefficients are complete and executable, but the fitted row-level compression observations and regression weights are not republished. |
| [`cu_sun_2010_mrs3_1`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Source coefficients are complete and executable, but the fitted row-level compression observations and regression weights are not republished. |
| [`cu_sun_2010_low_vn`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`cu_sun_2010_low_mrs3`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`cu_sun_2010_low_sms3`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`cu_sun_2010_low_sms4`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`cu_sun_2010_low_bn`](https://doi.org/10.1515/zna-2010-1-202) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`fe_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`fesio3_liquid_sun_2019_2500k_bm4_1`](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2018GL081421) | `fesio3_liquid_sun_2019_table1_pvt` | — | — | —/— | not_refittable — The bundled Table 1 grid mixes liquid and nonliquid simulations. Figure 1, rather than the numerical table, identifies the liquid states used by the source fit, so the table is a checkpoint resource and not an asserted exact regression input. |
...
| [`gold_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`indium_bct_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`iridium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`iron_dewaele_2019_mao_vinet`](https://www.mdpi.com/2075-163X/9/11/684) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`iron_dewaele_2019_dor_vinet`](https://www.mdpi.com/2075-163X/9/11/684) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`iron_zhang_2025_fit1_birch_murnaghan_3_mgd`](https://www.mdpi.com/2073-4352/15/3/221) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`iron_zhang_2025_fit2_birch_murnaghan_3_mgd`](https://www.mdpi.com/2073-4352/15/3/221) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`iron_zhang_2025_fit5_vinet_mgd`](https://www.mdpi.com/2073-4352/15/3/221) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`lead_fcc_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`lead_hcp_dewaele_2019_mao_vinet`](https://www.mdpi.com/2075-163X/9/11/684) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`lead_hcp_dewaele_2019_dor_vinet`](https://www.mdpi.com/2075-163X/9/11/684) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`lithium_9r_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`magnesium_hcp_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`manganese_alpha_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`nickel_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`niobium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`osmium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`palladium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`platinum_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`rhenium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`rhodium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`rubidium_bcc_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`ruthenium_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`scandium_hcp_lejaeghere_2016_wien2k_pbe_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — The official archive preserves the complete EOS coefficients and frozen structure, but not the seven row-level E(V) values for this code; direct coefficient refitting is unavailable. |
| [`scandium_hcp_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`silver_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`sodium_9r_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`strontium_fcc_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`tantalum_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`tantalum_dewaele_2004_mao_ruby_vinet`](https://doi.org/10.1103/PhysRevB.70.094112) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`tantalum_dewaele_2004_revised_ruby_vinet`](https://doi.org/10.1103/PhysRevB.70.094112) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`thallium_hcp_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`tin_alpha_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`titanium_alpha_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`tungsten_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`tungsten_dewaele_2004_mao_ruby_vinet`](https://doi.org/10.1103/PhysRevB.70.094112) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`vanadium_bcc_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`yttrium_hcp_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
| [`zinc_hcp_lejaeghere_2016_wien2k_pbe_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — The official archive preserves the complete EOS coefficients and frozen structure, but not the seven row-level E(V) values for this code; direct coefficient refitting is unavailable. |
| [`zinc_hcp_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
| [`zirconium_alpha_lejaeghere_2014_experimental_corrected_bm3`](https://archive.materialscloud.org/record/2023.133) | `parameterization_only` | — | — | —/— | not_refittable — Published coefficients are executable; this import does not claim a new refit of row-level observations. |
...
- `aluminum_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `aluminum_dewaele_2004_mao_ruby_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `barium_bcc_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `bismuth_a7_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `bridgmanite_chantel_2012_bm3_mgd`: The bundled density and acoustic-velocity observations validate the published thermoelastic pressure surface in the dedicated Chantel reproduction. The stored K0 and K0-prime come from the source's combined acoustic fit, so these rows are not independent observations for a generic pressure-volume coefficient refit.
...
- `ca_perovskite_noguchi_2013_bm2_mgd_1`: Table 1 contains 54 P-V-T rows, paired Fei/Holmes pressures, Pt lattice parameters, and three explicit fit exclusions. A complete local transcription was used for the audit and independent refit, but is not redistributed because the subscription article states no reusable data license.
- `ca_perovskite_sun_2016_bm3_3`: The published thermal-EOS coefficients are transcribed directly. The article's P-V-T table is not redistributed because no open table-data license was identified.
...
- `cadmium_hcp_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `calcium_fcc_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `cesium_bcc_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `chromium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `cobalt_hcp_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `copper_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `copper_dewaele_2004_mao_ruby_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `cu_sun_2010_sms4_1`: Source coefficients are complete and executable, but the fitted row-level compression observations and regression weights are not republished.
- `cu_sun_2010_sms3_1`: Source coefficients are complete and executable, but the fitted row-level compression observations and regression weights are not republished.
- `cu_sun_2010_mrs3_1`: Source coefficients are complete and executable, but the fitted row-level compression observations and regression weights are not republished.
- `cu_sun_2010_low_vn`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `cu_sun_2010_low_mrs3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `cu_sun_2010_low_sms3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `cu_sun_2010_low_sms4`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `cu_sun_2010_low_bn`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `fe_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `gold_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `indium_bct_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `iridium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `iron_dewaele_2019_mao_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `iron_dewaele_2019_dor_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `iron_zhang_2025_fit1_birch_murnaghan_3_mgd`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `iron_zhang_2025_fit2_birch_murnaghan_3_mgd`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `iron_zhang_2025_fit5_vinet_mgd`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `lead_fcc_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `lead_hcp_dewaele_2019_mao_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `lead_hcp_dewaele_2019_dor_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `lithium_9r_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `magnesium_hcp_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `manganese_alpha_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `mgal2o4_cafe2o4_funamori_1998_bm2_1`: The primary article reports only the ambient and compressed endpoint for this polymorph. Those two states reproduce the published fixed-V0, fixed-K0-prime curve in the dedicated Funamori reproduction, but do not provide enough degrees of freedom for the generic refit campaign.
...
- `nickel_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `niobium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `osmium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `palladium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `platinum_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `rhenium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `rhodium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `rubidium_bcc_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `ruthenium_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `scandium_hcp_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `silver_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `sodium_9r_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `strontium_fcc_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `tantalum_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `tantalum_dewaele_2004_mao_ruby_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
- `tantalum_dewaele_2004_revised_ruby_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `thallium_hcp_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `tin_alpha_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `titanium_alpha_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `tungsten_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `tungsten_dewaele_2004_mao_ruby_vinet`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `vanadium_bcc_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `yttrium_hcp_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
...
- `zinc_hcp_lejaeghere_2014_experimental_corrected_bm3`: Published coefficients are executable; this import does not claim a new refit of row-level observations.
