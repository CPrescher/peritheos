...
The campaign covers all **487** EOS records. **154** achieve uncertainty parity, **86** are numerically similar, **[31](#parity-not-achieved)** do not achieve parity, **216** cannot be directly refitted, and **0** attempts failed before comparison.
...
| [`iridium_anzellini_2025_bm3_1`](https://doi.org/10.1038/s43246-025-00963-4) | `iridium_anzellini_2025_tables_s1_s3_pvt` | 122 | `alpha0` 1.87e-05 → 1.77403e-05 | 3.13751/3.03257 | parity — The exact Equations 1-3 thermal correction and source temperature average are reproduced. With the published BM3 reference held fixed, all 122 laser-heating rows independently refit alpha0. The article's complete simultaneous BM3+alpha0 regression cannot be rerun because the Monteseguro 300 K and present 833 K row-level observations, row selection after plus-or-minus 100 K averaging, weights, and covariance are not published. |
...
| [`phase_d_ant_a_shieh_2000_bm2_1`](https://doi.org/10.1016/S0012-821X(00)00033-9) | `parameterization_only` | — | — | —/— | not_refittable — The catalog record preserves a validated published parameterization but does not register row-level observations for an independent refit. |
| [`phase_d_ant_b_shieh_2000_bm2_1`](https://doi.org/10.1016/S0012-821X(00)00033-9) | `parameterization_only` | — | — | —/— | not_refittable — The catalog record preserves a validated published parameterization but does not register row-level observations for an independent refit. |
...
- `phase_d_ant_a_shieh_2000_bm2_1`: The catalog record preserves a validated published parameterization but does not register row-level observations for an independent refit.
- `phase_d_ant_b_shieh_2000_bm2_1`: The catalog record preserves a validated published parameterization but does not register row-level observations for an independent refit.
