...
The campaign covers all **813** EOS records. **155** achieve uncertainty parity, **62** are numerically similar, **11** have a coupled source reconstruction without an independent EOS refit, **[31](#parity-not-achieved)** do not achieve parity, **554** cannot be directly refitted, and **0** attempts failed before comparison.
