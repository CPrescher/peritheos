...
The campaign covers all **600** EOS records. **212** achieve uncertainty parity, **145** are numerically similar, **13** have a source reconstruction without an independent EOS refit, **[67](#parity-not-achieved)** do not achieve parity, **163** cannot be directly refitted, and **0** attempts failed before comparison.
...
The following **212** sections cover every completed refit that does not meet the strict `parity` definition. `similar` means
