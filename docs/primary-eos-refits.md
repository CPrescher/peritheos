...
The campaign covers all **553** EOS records. **144** achieve uncertainty parity, **61** are numerically similar, **[21](#parity-not-achieved)** do not achieve parity, **327** cannot be directly refitted, and **0** attempts failed before comparison.
