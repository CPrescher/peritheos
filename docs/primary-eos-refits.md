...
The campaign covers all **612** EOS records. **144** achieve uncertainty parity, **61** are numerically similar, **[21](#parity-not-achieved)** do not achieve parity, **386** cannot be directly refitted, and **0** attempts failed before comparison.
