...
The campaign covers all **598** EOS records. **211** achieve uncertainty parity, **144** are numerically similar, **13** have a source reconstruction without an independent EOS refit, **[67](#parity-not-achieved)** do not achieve parity, **163** cannot be directly refitted, and **0** attempts failed before comparison.
