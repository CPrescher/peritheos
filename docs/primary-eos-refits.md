...
The campaign covers all **488** EOS records. **157** achieve uncertainty parity, **87** are numerically similar, **[31](#parity-not-achieved)** do not achieve parity, **213** cannot be directly refitted, and **0** attempts failed before comparison.
