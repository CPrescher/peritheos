...
The campaign covers all **591** EOS records. **203** achieve uncertainty parity, **145** are numerically similar, **13** have a source reconstruction without an independent EOS refit, **[67](#parity-not-achieved)** do not achieve parity, **163** cannot be directly refitted, and **0** attempts failed before comparison.
