...
The campaign covers all **610** EOS records. **220** achieve uncertainty parity, **146** are numerically similar, **13** have a source reconstruction without an independent EOS refit, **[67](#parity-not-achieved)** do not achieve parity, **164** cannot be directly refitted, and **0** attempts failed before comparison.
...
The following **213** sections cover every completed refit that does not meet the strict `parity` definition. `similar` means
