...
The campaign covers all **615** EOS records. **147** achieve uncertainty parity, **61** are numerically similar, **[21](#parity-not-achieved)** do not achieve parity, **386** cannot be directly refitted, and **0** attempts failed before comparison.
