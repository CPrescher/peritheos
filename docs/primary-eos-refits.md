...
The campaign covers all **353** EOS records. **137** achieve uncertainty parity, **54** are numerically similar, **[20](#parity-not-achieved)** do not achieve parity, **142** cannot be directly refitted, and **0** attempts failed before comparison.
...
The following **74** sections cover every completed refit that does not meet the strict `parity` definition. `similar` means
