...
The campaign covers all **816** EOS records. **161** achieve uncertainty parity, **62** are numerically similar, **[31](#parity-not-achieved)** do not achieve parity, **562** cannot be directly refitted, and **0** attempts failed before comparison.
