...
The campaign covers all **486** EOS records. **155** achieve uncertainty parity, **86** are numerically similar, **[32](#parity-not-achieved)** do not achieve parity, **213** cannot be directly refitted, and **0** attempts failed before comparison.
