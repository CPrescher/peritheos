...
The campaign covers all **815** EOS records. **155** achieve uncertainty parity, **62** are numerically similar, **[31](#parity-not-achieved)** do not achieve parity, **567** cannot be directly refitted, and **0** attempts failed before comparison.
