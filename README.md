...
- A Peritheos-owned `.eosmat` schema and 286-material/815-record EOS library with optional
...
The normal catalog API constructs all 286 materials and 815 records directly
