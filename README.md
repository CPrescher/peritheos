...
- A Peritheos-owned `.eosmat` schema and 287-material/843-record EOS library with optional
...
The normal catalog API constructs all 286 materials and 843 records directly
