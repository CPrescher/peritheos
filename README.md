...
- A Peritheos-owned `.eosmat` schema and 214-material-document/585-record EOS library with optional
...
The normal catalog API constructs all 213 materials and 585 records directly
