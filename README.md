...
- A Peritheos-owned `.eosmat` schema and 287-material/830-record EOS library with optional
...
The normal catalog API constructs all 286 materials and 830 records directly
