...
- A Peritheos-owned `.eosmat` schema and 210-material-document/574-record EOS library with optional
...
The normal catalog API constructs all 209 materials and 574 records directly
