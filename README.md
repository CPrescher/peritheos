...
- A Peritheos-owned `.eosmat` schema and 217-material-document/589-record EOS library with optional
...
The normal catalog API constructs all 216 materials and 589 records directly
