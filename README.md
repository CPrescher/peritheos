...
- A Peritheos-owned `.eosmat` schema and 286-material/821-record EOS library with optional
...
The normal catalog API constructs all 286 materials and 821 records directly
