...
- A Peritheos-owned `.eosmat` schema and 211-material-document/581-record EOS library with optional
...
The normal catalog API constructs all 210 materials and 581 records directly
