...
- A Peritheos-owned `.eosmat` schema and 225-material-document/614-record EOS library with optional
...
The normal catalog API constructs 223 materials and 612 executable records directly
