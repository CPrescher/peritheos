...
- A Peritheos-owned `.eosmat` schema and 223-material-document/610-record EOS library with optional
...
The normal catalog API constructs all 222 materials and 610 records directly
