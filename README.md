...
- A Peritheos-owned `.eosmat` schema and 210-material-document/584-record EOS library with optional
...
The normal catalog API constructs all 209 materials and 584 records directly
