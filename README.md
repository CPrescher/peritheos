...
- A Peritheos-owned `.eosmat` schema and 223-material-document/600-record EOS library with optional
...
The normal catalog API constructs all 222 materials and 600 records directly
