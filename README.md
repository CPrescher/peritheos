...
- A Peritheos-owned `.eosmat` schema and 222-material-document/598-record EOS library with optional
...
The normal catalog API constructs all 221 materials and 598 records directly
