...
- A Peritheos-owned `.eosmat` schema and 285-material/654-record EOS library with optional
...
The normal catalog API constructs all 285 materials and 654 records directly
