...
- A Peritheos-owned `.eosmat` schema and 141-material/226-record EOS library with optional
...
The normal catalog API constructs all 141 materials and 226 records directly
