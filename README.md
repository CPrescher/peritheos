...
- A Peritheos-owned `.eosmat` schema and 218-material-document/591-record EOS library with optional
...
The normal catalog API constructs all 217 materials and 591 records directly
