...
- A Peritheos-owned `.eosmat` schema and 208-material/486-record EOS library with optional
...
The normal catalog API constructs all 208 materials and 486 records directly
