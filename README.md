...
- A Peritheos-owned `.eosmat` schema and 286-material/812-record EOS library with optional
...
The normal catalog API constructs all 286 materials and 812 records directly
