...
- A Peritheos-owned `.eosmat` schema and 212-material-document/583-record EOS library with optional
...
The normal catalog API constructs all 211 materials and 583 records directly
