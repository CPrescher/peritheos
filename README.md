...
- A Peritheos-owned `.eosmat` schema and 286-material/826-record EOS library with optional
...
The normal catalog API constructs all 286 materials and 826 records directly
