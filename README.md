...
- A Peritheos-owned `.eosmat` schema and 212-material-document/578-record EOS library with optional
...
The normal catalog API constructs 210 materials and 576 executable records directly
