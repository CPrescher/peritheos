...
- A Peritheos-owned `.eosmat` schema and 285-material/615-record EOS library with optional
...
The normal catalog API constructs all 285 materials and 615 records directly
