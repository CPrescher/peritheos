...
- A Peritheos-owned `.eosmat` schema and 286-material/822-record EOS library with optional
...
The normal catalog API constructs all 286 materials and 822 records directly
