...
- A Peritheos-owned `.eosmat` schema and 287-material/819-record EOS library with optional
...
The normal catalog API constructs all 287 materials and 819 records directly
