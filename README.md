...
- A Peritheos-owned `.eosmat` schema and 215-material-document/586-record EOS library with optional
...
The normal catalog API constructs all 214 materials and 586 records directly
